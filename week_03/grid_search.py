...
lsmt_units = [64, 128, 256]
sequence_lenghts = [32, 64, 128]

for batch_size, lsmt_unit_count, sequence_length in product(batch_sizes, lsmt_units, sequence_lenghts):
  print(f"Training model with batch_size={batch_size}, lstm_units={lsmt_unit_count}, sequence_length={sequence_length}")
  ...
  model.save(f'models/grid_search/lstm_{lsmt_unit_count}-seq_{sequence_length}-batch_{batch_size}.keras')
